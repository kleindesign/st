...
export default function Home() {
  ...
  return (
    <div className="w-full h-screen overflow-x-hidden snap-x snap-mandatory font-outfit">
      <div ref={el => sectionsRef.current[0] = el} className="relative w-screen h-screen flex flex-col items-center justify-center p-4 text-center snap-start bg-gray-900">
        ...
        <div className="relative z-10">
          ...
          <Button
            ...
            className="bg-[#FF611A] hover:bg-[#FF611A]/90 text-white font-semibold text-lg py-3 px-8 rounded-full transition-colors duration-200"
          >
            Learn More
          </Button>
        </div>
      ...
      <div ref={el => sectionsRef.current[1] = el} className="w-screen h-screen flex flex-col items-center justify-center p-4 text-center snap-start bg-blue-100">
        ...
        <Button 
          onClick={scrollToNextSection}
          className="bg-[#FF611A] hover:bg-[#FF611A]/90 text-white font-semibold rounded-full"
        >
          Next: Features
        </Button>
      </div>

      <div ref={el => sectionsRef.current[2] = el} className="w-screen h-screen flex flex-col items-center justify-center p-4 text-center snap-start bg-green-100">
      ...
      <div ref={el => sectionsRef.current[3] = el} className="w-screen h-screen flex flex-col items-center justify-center p-4 text-center snap-start bg-purple-100">
